...
export class AccessService {
  ...
  private async handleLogAdminFacialRecognitionMobile(userData: any, facialRecognition: any, environmentId: string, accessDto: any) {
    ...
    const user = await lastValueFrom(
      this.httpService.get(`${process.env.USERS_SERVICE_URL}/${userData.userId}`)
    )
      .then((response) => response.data)
      .catch((error) => {
    ...
    if (facialRecognition.result === false) {
      this.accessLogService.create(
        LogsCerberusConstants.accessFailedWhenMobileRequest(
          user.name,
          environment.name,
          userData.accessType,
          {
  ...
  private handleUnauthorizedUserAccess(userData: any, data: any, accessDto: any, environmentId: string) {
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenEnvironmentAccessNotFound(
        userData.userName,
  ...
  //   const getUserImageUrl = `${process.env.USERS_SERVICE_URL}/${userId}/image`;
  ...
  //     if (err) {
  //       this.accessLogService.create(
  //         LogsCerberusConstants.failedToWriteUserImageToDisk(
  //           null,
  //           userId,
  //           null,
  //           {
  ...
  //     if (err) {
  //       this.accessLogService.create(
  //         LogsCerberusConstants.failedToWriteAccessImageToDisk(
  //           null,
  //           null,
  //           null,
  //           {
  ...
  async sendLogWhenFacialRecognitionSucceeds(userData: any, userAccessData: any, accessDto: any) { // AccessByMicrocontrollerDeviceDto
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessOkWhenUserHasAccess(
        user.name,
  ...
  async sendLogWhenFingerprintSucceeds(userData: any, envId: any, accessDto: any) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessOkWhenMobileRequest(
        user.name,
        environment.name,
        userData.accessType,
        {
  ...
  async sendLogWhenFacialRecognitionFails(userData: any, userAccessData: any, accessDto: AccessByMicrocontrollerDeviceDto) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenFacialRecognitionIsNotValid(
        user.name,
        userAccessData.environmentName,
        userData.accessType,
        {
  ...
  async sendLogWhenEsp32NotFound(accessDto: AccessByMicrocontrollerDeviceDto) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenEsp32NotFound(
        accessType,
        accessDto.mac,
        {
          ip: accessDto.ip,
  ...
  async sendLogWhenRFIDNotFound(accessDto: AccessByMicrocontrollerDeviceDto, environmentId: string) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenTagRFIDNotFound(
        accessDto.rfid,
        environment.name,
        {
          ...accessDto,
  ...
  async sendLogWhenMobileNotFound(accessDto: AccessByMicrocontrollerDeviceDto, environmentId: string) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenDeviceMobileNotFound(
        accessDto.mac,
        environment.name,
        {
          ...accessDto,
  ...
  async sendLogWhenUserPinIsNotValid(accessDto: AccessByMicrocontrollerDeviceDto, environmentId: string, userName: string, userId: string) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenUserPinIsNotValid(
        accessDto.pin,
        userName,
        environment.name,
        {
  ...
  async sendLogWhenUserDocumentNotFound(accessDto: AccessByMicrocontrollerDeviceDto, environmentId: string) {
    ...
    this.accessLogService.create(
      LogsCerberusConstants.accessDeniedWhenUserDocumentNotFound(
        accessDto.document,
        environment.name,
        {
