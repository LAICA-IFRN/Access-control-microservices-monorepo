...
export class CreateForbiddenResponseEntity {
  @ApiProperty()
  @ApiResponseProperty({example: "Can't create esp32 record"})
  message: string
}
...
export class FindAllForbiddenResponseEntity {
  @ApiProperty()
  @ApiResponseProperty({example: "Can't find esp32 records"})
  message: string
}

export class FindOneNotFoundResponseEntity {
  @ApiProperty()
  @ApiResponseProperty({example: 'Esp32 not found'})
  message: string
}
...
export class UpdateForbiddenResponseEntity {
  @ApiProperty()
  @ApiResponseProperty({example: "Can't update esp32 record"})
  message: string
}
...
export class UpdateStatusForbiddenResponseEntity {
  @ApiProperty()
  @ApiResponseProperty({example: "Can't change esp32 status"})
  message: string
}
