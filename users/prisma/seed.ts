...
async function createUsers() {
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user4', roundsOfHashing),
      name: 'User 4',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user5', roundsOfHashing),
      name: 'User 5',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user6', roundsOfHashing),
      name: 'User 6',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user7', roundsOfHashing),
      name: 'User 7',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user8', roundsOfHashing),
      name: 'User 8',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user9', roundsOfHashing),
      name: 'User 9',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user10', roundsOfHashing),
      name: 'User 10',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user11', roundsOfHashing),
      name: 'User 11',
      document: '20211014040011',
      document_type_id: 2,
      active: true,
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user13', roundsOfHashing),
      name: 'User 13',
  ...
  await prisma.user.create({
    data: {
      ...
      password: await bcrypt.hash('user14', roundsOfHashing),
      name: 'User 14',
